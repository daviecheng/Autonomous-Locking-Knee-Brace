 ...
 *   the preset flexion is locked. If not, it will check if the brace is locked and wait for 5 consecutive nonfall 
 *   readings to unlock.
 *   
 */
...
#include "chestHipRF.h" // C code generated from Python that contains the trained Random Forest classifier
...
void setup() {
  ...
  /*Uncomment below to check sampling time or to find a delay for sampling time. (1)*/
//  time=0;

  // set number of falls and nonfalls to zero (used to determine accuracy)
  fall=0;
  nonfall=0;
}
...
void loop() {
  ...
  /*Uncomment below to check sampling time or to find a delay for sampling time. (2)*/
//  time = millis();
...
//  printFeatures();
  ...
  /*Uncomment below to check sampling time or to find a delay for sampling time. (3)*/
